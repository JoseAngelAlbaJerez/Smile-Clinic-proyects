...
*/
    ...
    <table class="invoice-info-container">
        ...
        <tr>
            <td> 
                Fecha: <strong>{{$Abonoheader->created_at->toDateString()}}</strong>
            </td>
            <td>
        ...
        <tr>
            <td>
                No. de Cuenta: <strong>{{$CXC->id}}</strong>
            </td>
            <td>
    ...
    <table class="line-items-container">
        <thead>
            <th width="200px">#</th>
            <th class="ml-4" >Procedimiento</th>
            <th>Tratamiento</th>
        ...
        <tbody>
            <tr>
                <td class="payment-info">
                    ...
                    <div>
                        Estado: <strong>{{$CXC->status}}</strong>
                    </div>
                </td>
                <td >
